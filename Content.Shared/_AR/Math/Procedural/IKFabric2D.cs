...
public sealed class IKFabric2D
{
    ...
    public IReadOnlyList<Segment2D> Segments => _segments;

    public IKFabric2D(Vector2 position, int segments, float segmentLength, bool @fixed = true) : this(position, segments, 0, segmentLength, @fixed)
    {
    }
